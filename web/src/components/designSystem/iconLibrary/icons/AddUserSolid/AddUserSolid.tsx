...
export const AddUserSolid = ({
	...
	return (
		<svg
			...
			data-testid='AddUserSolid-svg-component'
			transform={`rotate(${rotate}) translate(${translateX}, ${translateY}) scale(${scaleX}, ${scaleY})`}
			fill={color}
			width={width}
			height={height}>
			<title>{title || 'AddUserSolid'}</title>
			...
			<path
				fillRule='evenodd'
				clipRule='evenodd'
				d='M16 15C16 17.2091 14.2091 19 12 19C9.79086 19 8 17.2091 8 15C8 12.7909 9.79086 11 12 11C14.2091 11 16 12.7909 16 15ZM14.5 15C14.5 15.2761 14.2761 15.5 14 15.5H12.5V17C12.5 17.2761 12.2761 17.5 12 17.5C11.7239 17.5 11.5 17.2761 11.5 17V15.5H10C9.72386 15.5 9.5 15.2761 9.5 15C9.5 14.7239 9.72386 14.5 10 14.5H11.5V13C11.5 12.7239 11.7239 12.5 12 12.5C12.2761 12.5 12.5 12.7239 12.5 13V14.5H14C14.2761 14.5 14.5 14.7239 14.5 15Z'
				fill='current'
			/>
		</svg>
	);
